...
public class FadingShadow {
    ...
    public static final String MODID = "fadingshadow";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "fadingshadow" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "fadingshadow" namespace
    ...
    // Creates a new BlockItem with the id "fadingshadow:example_block", combining the namespace and path
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

    // Creates a new food item with the id "fadingshadow:example_id", nutrition 1 and saturation 2
 ...
 */
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS) {   //虽然这个看起来并不像食物
